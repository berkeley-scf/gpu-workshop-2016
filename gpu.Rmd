...
Materials for this tutorial, including the R markdown file that was used to create this document are available on github at [https://github.com/berkeley-scf/git-workshop-2016](https://github.com/berkeley-scf/gpu-workshop-2016).  You can download the files by doing a git clone:
